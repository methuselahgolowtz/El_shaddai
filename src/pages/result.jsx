...
import image1 from "../assets/images/matokeo.png";
import image2 from "../assets/images/matokeo2.png";
import image3 from "../assets/images/matokeo3.png"
...
<div className="separator my-40"></div>
        ...
        <div className="font-cabinet w-screen  flex justify-center items-center text-2xl p-3 my-4">
            <p className="bold border-b-2 border-amber-400 p-3 ">School National results</p>
        </div>
